...
def showSearchResults():
    ...
    compareLists()
    cleanDir1.config(state=tkinter.NORMAL)
    cleanDir2.config(state=tkinter.NORMAL)
    cleanBoth.config(state=tkinter.NORMAL)
...
cleanDir1 = Button(mainScreen, text="Clean Dir1", command = lambda: cleanDir(coincidenceList1))
cleanDir1.grid(row=8, column=0)
cleanDir1.config(state=tkinter.DISABLED)
cleanDir2 = Button(mainScreen, text="Clean Dir2", command = lambda: cleanDir(coincidenceList2))
cleanDir2.grid(row=8, column=1)
cleanDir2.config(state=tkinter.DISABLED)
cleanBoth = Button(mainScreen, text="Clean Both", command = lambda: cleanDir(coincidenceList2))
cleanBoth.grid(row=8, column=2)
cleanBoth.config(state=tkinter.DISABLED)
